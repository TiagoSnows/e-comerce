	...
	<footer class="bg3 p-t-75 p-b-32">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Nossa loja é localizada na Av. Brigadeiro Luís Antônio, 864, 1º ANDAR - Bela Vista, São Paulo - SP, 01318-001. 
						<br>Venha e entre na dimensão paralela dos nerds!</br> 
					</p>
			...
			<div class="p-t-40">
				...
				Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos os direitos reservados | Turminha do Bem e CIA <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://github.com/TiagoSnows" target="_blank">FMU-4ºADS</a> &amp; DISTRÍBUIDO POR <a href="localhost/ecomercePHP/loja/index.php" target="_blank"> Dick Vigarista & Muttley </a>
				</p>
			</div>
		</div>
	</footer>
